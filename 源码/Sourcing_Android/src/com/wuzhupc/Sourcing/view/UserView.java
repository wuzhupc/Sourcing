...
public class UserView extends BaseView
{
	...
	private void setShowUserInfo()
	{
		...
		else
		{
			...
			imageService.setThumbnail(miv_userpic, userVO.getUserphoto(),getResources().getDrawable(R.drawable.icon_userpic_bg));
	...
	public void initContentView()
	{
		...
		mbt_reg_account = (Button)v.findViewById(R.id.userview_reg_account_bt);
		}
	}
	...
	public void onReg_AccountClick(View v)
	{
		...
		if(userVO==null)
			//注册
			((BaseActivity)mContext).runBrowser(getResources().getString(R.string.url_reg_progress));
		else
			changeAccount();
	}
	...
	{
		BaseDialog dialog = new BaseDialog(mContext,BaseDialog.DIALOG_TYPE_TWOBTN);
	...
	public void onLogin_PwdClick(View v)
	{
		...
		{
			//登录
			((BaseActivity)mContext).runActivity(false, UserLoginActivity.class);
		}
		else
		{
			//修改密码
