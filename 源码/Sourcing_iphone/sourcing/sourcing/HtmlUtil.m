...
+ (NSString *) getHtmlHead
{
    ...
    return [NSString stringWithFormat:@"<html><head><meta http-equiv=\"Content-Type\" content=\"text/html;charset=utf-8\">%@</head><body style=\"background-color:#FCF2E9\">", autoloadimgscript];
}
