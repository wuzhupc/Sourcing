...
+ (NSString *) getHtmlHead
{
    ...
    return [NSString stringWithFormat:@"<html><head><meta http-equiv=\"Content-Type\" content=\"text/html;charset=utf-8\">%@<style type=\"text/css\">body {background-color:#e9f2fc;}</style></head><body>", autoloadimgscript];
}
